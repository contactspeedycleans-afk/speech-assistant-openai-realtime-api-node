    ...
    },
    {
        ...
        function: {
            ...
            parameters: {
                ...
                required: ['customerName', 'customerFirstName', 'customerPhone', 'serviceAddress', 'streetNumber', 'street', 'city', 'state', 'zip', 'serviceType', 'requestedDate', 'requestedStartTime', 'arrivalWindow', 'durationMinutes', 'recurringFrequency', 'quotedPrice', 'customerConfirmed'],
                additionalProperties: false
            }
        }
    },
...
async function createOctopusBooking(args, customerPhone) {
    ...
    const required = ['customerName', 'customerFirstName', 'serviceAddress', 'streetNumber', 'street', 'city', 'state', 'zip', 'serviceType', 'requestedDate', 'requestedStartTime', 'arrivalWindow'];
...
export async function runSmsReceptionist({
    ...
    const contextMessage = [
        ...
        JSON.stringify({ identity, futureBookings: summarizeBookings(customerBookings) }),
