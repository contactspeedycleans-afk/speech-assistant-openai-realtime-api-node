...
If the tool returns outcome "processing," the caller-facing wait limit was reached but creation is continuing safely in the background. Stop the hold music, say: "I've submitted your appointment. Your booking number will be texted and emailed as soon as Octopus finishes processing it." Do not call the booking tool again during that call and do not say Octopus confirmed it yet.
