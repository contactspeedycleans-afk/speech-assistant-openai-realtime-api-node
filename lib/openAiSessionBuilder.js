...
Before calling it, make sure the agreed booking has: customer name, phone, email when available, complete service address, service type, date, start time, duration, quoted price, and frequency. Reuse reliable information already supplied in the call context; do not make the customer repeat it.
